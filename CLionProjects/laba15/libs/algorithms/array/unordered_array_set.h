#ifndef LABA15_UNORDERED_ARRAY_SET_H
#define LABA15_UNORDERED_ARRAY_SET_H
#include <stdlib.h>
#include <assert.h>
#include <memory.h>
#include <stdio.h>
...
unordered_array_set unordered_array_set_create_from_array(const int *a, size_t n);
...
#endif //LABA15_UNORDERED_ARRAY_SET_H
